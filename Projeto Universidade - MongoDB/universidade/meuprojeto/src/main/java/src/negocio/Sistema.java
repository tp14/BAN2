...
public class Sistema {
	public void cadastrarProfessor(Professor professor) throws InsertException, ClassNotFoundException {
		ProfessorDAO.getInstance().insert(professor);
	}
	
	public List<Professor> buscarProfessores() throws SelectException, ClassNotFoundException{
		return ProfessorDAO.getInstance().getAll();
	}

	public void removerProfessor(Professor professor) throws DeleteException, ClassNotFoundException {
		ProfessorDAO.getInstance().delete(professor);
	}

	public void alterarProfessor(Professor professor) throws UpdateException, ClassNotFoundException { 
		ProfessorDAO.getInstance().update(professor);
	}

	public Professor getProfessor(int codProfessor) throws SelectException, ClassNotFoundException {
