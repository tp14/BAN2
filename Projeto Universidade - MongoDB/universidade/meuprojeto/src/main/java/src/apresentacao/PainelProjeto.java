...
import src.persistencia.ProjetoDAO;
...
public class PainelProjeto {
    ...
    public void criarPainelBuscarProjeto(JPanel panelBuscar, JLayeredPane layeredBuscar) {
        ...
        final JPanel panelBuscarProjeto = new JPanel();
    ...
    public void criaPainelTabelProjeto(JPanel panelBuscarProjeto, JLayeredPane layeredBuscar,JPanel panelBuscar) {
		final JPanel finalPanelBusca = panelBuscar;
		final JPanel finalPanelBuscarProjeto = panelBuscarProjeto;
		finalPanelBuscarProjeto.setLayout(null);
		...
		finalPanelBuscarProjeto.add(bntAtualizarListaProjetos);
	}
    ...
    public void criarPainelAlterarProjeto(JPanel panelAlterar, JLayeredPane layeredAlterar){
        ...
        finalPanelAlterar.add(btnAlterarProjeto);
