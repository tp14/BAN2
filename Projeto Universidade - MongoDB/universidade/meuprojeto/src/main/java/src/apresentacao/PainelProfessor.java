...
import src.persistencia.ProfessorDAO;
...
public class PainelProfessor {
	...
	public void criarPainelBuscarProfessor(JPanel panelBuscar, JLayeredPane layeredBuscar) {
        ...
        final JPanel panelBuscarProfessor = new JPanel();
    ...
    public void criaPainelTabelProfessor(JPanel panelBuscarProfessor, JLayeredPane layeredBuscar,JPanel panelBuscar) {
		final JPanel finalPanelBusca = panelBuscar;
		final JPanel finalPanelBuscarProfessor = panelBuscarProfessor;
		finalPanelBuscarProfessor.setLayout(null);
		...
		finalPanelBuscarProfessor.add(bntAtualizarListaProfessores);
	}
    ...
    public void criarPainelAlterarProfessor(JPanel panelAlterar, JLayeredPane layeredAlterar){
        ...
        finalPanelAlterar.add(btnAlterarProfessor);
