...
import src.persistencia.TrabalhoProfessorDepartamentoDAO;
...
public class PainelTrabalhoProfessorDepartamento {
   ...
   JTextField textDeletarTrabalhoProfessorDepartamento = new JTextField();
    ...
    public void criarPainelBuscarTrabalhoProfessorDepartamento(JPanel panelBuscar, JLayeredPane layeredBuscar) {
        ...
        final JPanel panelBuscarTrabalhoProfessorDepartamento = new JPanel();
    ...
    public void criaPainelTabelTrabalhoProfessorDepartamento(JPanel panelBuscarTrabalhoProfessorDepartamento, JLayeredPane layeredBuscar,JPanel panelBuscar) {
		final JPanel finalPanelBusca = panelBuscar;
		final JPanel finalPanelBuscarTrabalhoProfessorDepartamento = panelBuscarTrabalhoProfessorDepartamento;	
		finalPanelBuscarTrabalhoProfessorDepartamento.setLayout(null);
		...
		finalPanelBuscarTrabalhoProfessorDepartamento.add(scrollTrabalhoProfessorDepartamentos);
		...
		btnVoltaBuscalistarTrabalhoProfessorDepartamentos.addMouseListener(new MouseAdapter() {
			public void mouseClicked(MouseEvent e) {
				finalPanelBuscarTrabalhoProfessorDepartamento.setVisible(false);
				finalPanelBusca.setVisible(true);
			}
		});
		btnVoltaBuscalistarTrabalhoProfessorDepartamentos.setBounds(164, 344, 89, 23);
		finalPanelBuscarTrabalhoProfessorDepartamento.add(btnVoltaBuscalistarTrabalhoProfessorDepartamentos);
		...
		finalPanelBuscarTrabalhoProfessorDepartamento.add(bntAtualizarListaTrabalhoProfessorDepartamentos);
	}
    ...
    public void criarPainelAlterarTrabalhoProfessorDepartamento(JPanel panelAlterar, JLayeredPane layeredAlterar){
        ...
        finalPanelAlterar.add(lblAlterarTrabalhoProfessorDepartamento);
        ...
        finalPanelAlterar.add(textCodigoDigitadoTrabalhoProfessorDepartamento);
        ...
        finalPanelAlterar.add(btnAlterarProfessorDepartamento);
