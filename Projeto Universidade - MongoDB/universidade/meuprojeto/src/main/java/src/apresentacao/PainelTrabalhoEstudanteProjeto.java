...
import src.persistencia.TrabalhoEstudanteProjetoDAO;
...
public class PainelTrabalhoEstudanteProjeto {
   ...
   JTextField textDeletarTrabalhoEstudanteProjeto = new JTextField();
    ...
    public void criarPainelBuscarTrabalhoEstudanteProjeto(JPanel panelBuscar, JLayeredPane layeredBuscar) {
        ...
        final JPanel finalPanelBuscarTrabalhoEstudanteProjeto = new JPanel();
		final JPanel finalPanelBusca = panelBuscar;

        criaPainelTabelTrabalhoEstudanteProjeto(finalPanelBuscarTrabalhoEstudanteProjeto, layeredBuscar, panelBuscar);
		...
		btnListarTrabalhoEstudanteProjetos.addMouseListener(new MouseAdapter() {
			public void mouseClicked(MouseEvent e) {
				...
				finalPanelBuscarTrabalhoEstudanteProjeto.setVisible(true);
			}
		});
    ...
    public void criaPainelTabelTrabalhoEstudanteProjeto(JPanel panelBuscarTrabalhoEstudanteProjeto, JLayeredPane layeredBuscar,JPanel panelBuscar) {
		final JPanel finalPanelBusca = panelBuscar;
		final JPanel finalPanelBuscarTrabalhoEstudanteProjeto = panelBuscarTrabalhoEstudanteProjeto;	
		finalPanelBuscarTrabalhoEstudanteProjeto.setLayout(null);
		...
		finalPanelBuscarTrabalhoEstudanteProjeto.add(scrollTrabalhoEstudanteProjetos);
		...
		btnVoltaBuscalistarTrabalhoEstudanteProjetos.addMouseListener(new MouseAdapter() {
			public void mouseClicked(MouseEvent e) {
				finalPanelBuscarTrabalhoEstudanteProjeto.setVisible(false);
				finalPanelBusca.setVisible(true);
			}
		});
		btnVoltaBuscalistarTrabalhoEstudanteProjetos.setBounds(164, 344, 89, 23);
		finalPanelBuscarTrabalhoEstudanteProjeto.add(btnVoltaBuscalistarTrabalhoEstudanteProjetos);
		...
		finalPanelBuscarTrabalhoEstudanteProjeto.add(bntAtualizarListaTrabalhoEstudanteProjetos);
	}
    ...
    public void criarPainelAlterarTrabalhoEstudanteProjeto(JPanel panelAlterar, JLayeredPane layeredAlterar){
        ...
        finalPanelAlterar.add(lblAlterarTrabalhoEstudanteProjeto);
        ...
        finalPanelAlterar.add(textCodigoDigitadoTrabalhoEstudanteProjeto);
        ...
        finalPanelAlterar.add(btnAlterarEstudanteProjeto);
