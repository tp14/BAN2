...
public class PainelEstudante {
    ...
    public void criarPainelBuscarEstudante(JPanel panelBuscar, JLayeredPane layeredBuscar) {
        ...
        JPanel panelBuscarEstudantes = new JPanel();

        criaPainelTabelEstudante(panelBuscarEstudantes, layeredBuscar, panelBuscar);

		btnListarEstudantes.addMouseListener(new MouseAdapter() {
			public void mouseClicked(MouseEvent e) {
				panelBuscar.setVisible(false);
				listarEstudantes();
				panelBuscarEstudantes.setVisible(true);
			}
		});
    ...
    public void criaPainelTabelEstudante(JPanel panelBuscarEstudantes, JLayeredPane layeredBuscar,JPanel panelBuscar) {
		panelBuscarEstudantes.setLayout(null);
		layeredBuscar.add(panelBuscarEstudantes, "name_184619852570200");

		scrollEstudantes.setBounds(0, 0, 768, 333);
		scrollEstudantes.setViewportView(tableEstudantes);
		panelBuscarEstudantes.add(scrollEstudantes);
		
		JButton btnVoltaBuscaEstudantes = new JButton("Voltar");
		btnVoltaBuscaEstudantes.addMouseListener(new MouseAdapter() {
			public void mouseClicked(MouseEvent e) {
				panelBuscarEstudantes.setVisible(false);
				panelBuscar.setVisible(true);
			}
		});
		btnVoltaBuscaEstudantes.setBounds(164, 344, 89, 23);
		panelBuscarEstudantes.add(btnVoltaBuscaEstudantes);
		...
		panelBuscarEstudantes.add(bntAtualizarListaEstudantes);
	}
    ...
    public void deletarEstudante() {
		try {
			...
			System.err.println("Erro no codigo do estudante informado!");
			JOptionPane.showMessageDialog(null, "Erro no codigo do estudante informado!");
    ...
    public void alterarEstudante() {
		...
		try {
			...
			System.err.println(e4.getMessage());
			System.err.println("Erro no codigo do estudante informado ou no formato dos dados inseridos!");
			JOptionPane.showMessageDialog(null, "Erro no codigo do estudante informado ou no formato dos dados inseridos!");
		} catch (SelectException e5) {
			System.err.println(e5.getMessage());
			System.err.println("Erro ao acessar estudante!");
			JOptionPane.showMessageDialog(null, "Erro ao acessar estudante!");
